...
<nav class="relative w-full mx-auto bg-white border-b border-gray-200 py-2 px-4 sm:py-0 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8 xl:border-x dark:bg-gray-900 dark:border-neutral-700"
    ...
    <div class="flex items-center justify-between">
        <a class="flex item-center text-xl font-semibold dark:text-white gap-2" href={{ route('dashboard') }}
            aria-label="Brand">
    ...
    <form action="{{ route('logout') }}" method="POST">
        ...
        <button
            type="submit"
            class="min-w-[100px] flex items-center gap-x-2 font-medium text-gray-500 hover:text-red-600 sm:border-s sm:border-gray-300 sm:my-6 sm:ps-6 dark:border-neutral-700 dark:text-neutral-400 dark:hover:text-red-500">
